...
const ElementForm = () => {
  ...
  return (<form>
    <MyInput value={element.content} onChange={(e : {
        target: {
          value: any
        }
      }) => setElement({
    ...
    <MyInput value={element.Left} onChange={(e : {
        target: {
          value: any
        }
      }) => setElement({
...
} type="text" placeholder="х"/>
    <MyInput value={element.Top} onChange={(e : {
        target: {
          value: any
        }
      }) => setElement({
